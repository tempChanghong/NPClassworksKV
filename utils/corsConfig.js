...
export function createHttpCorsOptions(env = process.env) {
    return {
        ...
        maxAge: 86400,
        credentials: true,
        allowedHeaders: ["Content-Type", "Authorization", "X-Requested-With", "Accept", "X-Classworks-Device-ID", "X-Classworks-Screen-Token", "X-Classworks-Setup-Token", "X-NPClassworks-Migration-Passphrase", "If-Match", "X-NPEP-Version", "X-Request-Id"],
